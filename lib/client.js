...
Client.prototype.__products = async function(type, delisted=0, retry=0) {
...
Client.prototype.futures = function(delisted=0) {
  return this.__products(1, delisted)
}

Client.prototype.spot = function(delisted=0) {
